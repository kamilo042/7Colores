...
import cartIcon from '../../assets/cart.svg'; // Assuming you have an SVG named cart.svg

const Navbar = () => {
  return (
    <nav className="grid grid-cols-1 place-items-center py-4 bg-gray-100 relative">
      <img src={logo} alt="Company Logo" className="w-100 h-20 mb-4" />
      <ul className="flex space-x-6">
        ...
        <li>
          <a href="#" className="text-gray-700 hover:text-gray-900">Carrito</a>
        </li>
